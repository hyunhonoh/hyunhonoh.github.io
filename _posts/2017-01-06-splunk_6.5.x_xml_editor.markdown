...
Splunk 6.5.x부터 바뀐 XML Editor의 환경.
...
ace라고 하는 웹 editor로 simple xml을 변경하는 것 같고 이 editor의 단축키입니다.
개인적으로 autoindent가 있으면 좋을 것 같은데 아직 그 기능을 찾지는 못했네요.

올해도 즐거운 Splunk 활용을 기대하면서 포스트를 남깁니다.
